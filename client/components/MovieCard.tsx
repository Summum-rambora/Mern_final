...
export default function MovieCard({ movie }: MovieCardProps) {
  return (
    <Link href={`/movies/${movie.id}`}>
      <div className="glass-card overflow-hidden cursor-pointer h-full flex flex-col group hover-lift transition-all duration-500 border border-transparent hover:border-primary/20">
        {/* Заглавная буква с градиентом */}
        <div className="h-48 bg-gradient-to-br from-primary via-accent to-primary-dark flex items-center justify-center relative overflow-hidden">
          ...
          {/* Акцентный уголок */}
          <div className="absolute top-0 right-0 w-16 h-16 bg-gradient-to-br from-accent/80 to-transparent"></div>
